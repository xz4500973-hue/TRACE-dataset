...
module seqdet ( clk, rst_n, din, detected );
  ...
  NR2D0BWP12T30P140 U14 ( .A1(n6), .A2(n9), .ZN(next[2]) );
  ...
  OAI22D0BWP12T30P140 U19 ( .A1(din), .A2(n8), .B1(state[0]), .B2(n7), .ZN(
        next[1]) );
  NR2D0BWP12T30P140 U20 ( .A1(state[0]), .A2(state[1]), .ZN(n11) );
  AO22D0BWP12T30P140 U21 ( .A1(din), .A2(n11), .B1(n10), .B2(n9), .Z(next[0])
         );
endmodule
