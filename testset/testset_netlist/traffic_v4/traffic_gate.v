...
module traffic ( clk, rst_n, lights );
  output [2:0] lights;
  input clk, rst_n;
  wire   N10, N11, N12, N13, n9, n10, n11, n12, n13, n14, n15, n16;
  wire   [3:0] cnt;

  DFCNQD1BWP12T30P140 cnt_reg_1_ ( .D(N11), .CP(clk), .CDN(rst_n), .Q(cnt[1])
         );
  DFCNQD1BWP12T30P140 cnt_reg_2_ ( .D(N12), .CP(clk), .CDN(rst_n), .Q(cnt[2])
         );
  DFCNQD1BWP12T30P140 cnt_reg_0_ ( .D(N10), .CP(clk), .CDN(rst_n), .Q(cnt[0])
         );
  DFCNQD1BWP12T30P140 cnt_reg_3_ ( .D(N13), .CP(clk), .CDN(rst_n), .Q(cnt[3])
         );
  ...
  AN2D0BWP12T30P140 U21 ( .A1(n9), .A2(n16), .Z(N11) );
  INVD0BWP12T30P140 U22 ( .I(cnt[2]), .ZN(n15) );
  NR2D0BWP12T30P140 U23 ( .A1(n15), .A2(n9), .ZN(n11) );
  AOI21D0BWP12T30P140 U24 ( .A1(n15), .A2(n9), .B(n11), .ZN(N12) );
  NR2D0BWP12T30P140 U25 ( .A1(cnt[2]), .A2(n16), .ZN(n12) );
  INVD0BWP12T30P140 U26 ( .I(cnt[3]), .ZN(n13) );
  INVD0BWP12T30P140 U27 ( .I(n11), .ZN(n10) );
  OAI32D0BWP12T30P140 U28 ( .A1(n11), .A2(n12), .A3(n13), .B1(cnt[3]), .B2(n10), .ZN(N13) );
  AOI21D0BWP12T30P140 U29 ( .A1(n12), .A2(cnt[3]), .B(cnt[0]), .ZN(N10) );
