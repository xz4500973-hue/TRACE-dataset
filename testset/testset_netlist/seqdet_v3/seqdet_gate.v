...
module seqdet ( clk, rst_n, din, detected );
  input clk, rst_n, din;
  output detected;
  wire   N26, N27, N28, n10, n11, n12, n13, n14, n15;
  wire   [2:0] state;
  ...
  NR2D0BWP12T30P140 U18 ( .A1(state[0]), .A2(n10), .ZN(N28) );
