...
module PC ( clk, rst, EP, CP, PC_OUT );
  ...
  DFCNQD1BWP12T30P140 PC_OUT_r_reg_0_ ( .D(n14), .CP(clk), .CDN(n7), .Q(
        PC_OUT_r[0]) );
  ND2D0BWP12T30P140 U3 ( .A1(PC_OUT_r[0]), .A2(CP), .ZN(n2) );
  INVD0BWP12T30P140 U4 ( .I(PC_OUT_r[1]), .ZN(n3) );
  NR2D0BWP12T30P140 U5 ( .A1(n2), .A2(n3), .ZN(n1) );
  AOI21D0BWP12T30P140 U6 ( .A1(n2), .A2(n3), .B(n1), .ZN(n12) );
  ND2D0BWP12T30P140 U7 ( .A1(n1), .A2(PC_OUT_r[2]), .ZN(n5) );
  OA21D0BWP12T30P140 U8 ( .A1(n1), .A2(PC_OUT_r[2]), .B(n5), .Z(n10) );
  OA21D0BWP12T30P140 U9 ( .A1(PC_OUT_r[0]), .A2(CP), .B(n2), .Z(n14) );
  INVD0BWP12T30P140 U10 ( .I(rst), .ZN(n7) );
  AN2D0BWP12T30P140 U11 ( .A1(PC_OUT_r[2]), .A2(EP), .Z(PC_OUT[2]) );
  INVD0BWP12T30P140 U12 ( .I(EP), .ZN(n4) );
  NR2D0BWP12T30P140 U13 ( .A1(n3), .A2(n4), .ZN(PC_OUT[1]) );
  INVD0BWP12T30P140 U14 ( .I(PC_OUT_r[3]), .ZN(n6) );
  NR2D0BWP12T30P140 U15 ( .A1(n6), .A2(n4), .ZN(PC_OUT[3]) );
...
module MAR ( clk, LM, PC_IN, MAR_OUT );
  ...
  CKMUX2D0BWP12T30P140 U2 ( .I0(PC_IN[1]), .I1(MAR_OUT[1]), .S(LM), .Z(n2) );
  CKMUX2D0BWP12T30P140 U3 ( .I0(PC_IN[2]), .I1(MAR_OUT[2]), .S(LM), .Z(n3) );
  CKMUX2D0BWP12T30P140 U4 ( .I0(PC_IN[0]), .I1(MAR_OUT[0]), .S(LM), .Z(n1) );
  CKMUX2D0BWP12T30P140 U5 ( .I0(PC_IN[3]), .I1(MAR_OUT[3]), .S(LM), .Z(n4) );
endmodule
...
module SRAM ( CE, MAR_IN, SRAM_OUT );
  ...
  IND2D1BWP12T30P140 U7 ( .A1(MAR_IN[3]), .B1(MAR_IN[1]), .ZN(n8) );
  INVD0BWP12T30P140 U8 ( .I(SRAM_OUT[7]), .ZN(n3) );
  OAI21D0BWP12T30P140 U9 ( .A1(CE), .A2(n8), .B(n3), .ZN(SRAM_OUT[5]) );
  INVD0BWP12T30P140 U10 ( .I(MAR_IN[0]), .ZN(n4) );
  OAI31D0BWP12T30P140 U11 ( .A1(CE), .A2(MAR_IN[3]), .A3(n4), .B(n3), .ZN(
        SRAM_OUT[4]) );
  NR2D0BWP12T30P140 U12 ( .A1(MAR_IN[2]), .A2(n2), .ZN(n5) );
  AOI21D0BWP12T30P140 U13 ( .A1(MAR_IN[3]), .A2(n5), .B(CE), .ZN(SRAM_OUT[3])
         );
  OAI31D0BWP12T30P140 U14 ( .A1(CE), .A2(n4), .A3(n8), .B(n3), .ZN(SRAM_OUT[2]) );
  ND2D0BWP12T30P140 U15 ( .A1(MAR_IN[0]), .A2(MAR_IN[3]), .ZN(n6) );
  AOI31D0BWP12T30P140 U16 ( .A1(n5), .A2(n8), .A3(n6), .B(CE), .ZN(SRAM_OUT[0]) );
  INVD0BWP12T30P140 U17 ( .I(MAR_IN[2]), .ZN(n9) );
  OAI21D0BWP12T30P140 U18 ( .A1(MAR_IN[0]), .A2(MAR_IN[3]), .B(n6), .ZN(n7) );
  AOI31D0BWP12T30P140 U19 ( .A1(n9), .A2(n8), .A3(n7), .B(CE), .ZN(SRAM_OUT[1]) );
endmodule
...
module IR ( clk, LI, EI, SRAM_IN, IR_OUT_1, IR_OUT_2 );
  ...
  CKMUX2D0BWP12T30P140 U2 ( .I0(SRAM_IN[8]), .I1(IR_OUT_1[4]), .S(LI), .Z(n9)
         );
  CKMUX2D0BWP12T30P140 U3 ( .I0(SRAM_IN[3]), .I1(IR_OUT_r[3]), .S(LI), .Z(n4)
         );
  CKMUX2D0BWP12T30P140 U4 ( .I0(SRAM_IN[2]), .I1(IR_OUT_r[2]), .S(LI), .Z(n3)
         );
  CKMUX2D0BWP12T30P140 U5 ( .I0(SRAM_IN[1]), .I1(IR_OUT_r[1]), .S(LI), .Z(n2)
         );
  CKMUX2D0BWP12T30P140 U6 ( .I0(SRAM_IN[0]), .I1(IR_OUT_r[0]), .S(LI), .Z(n1)
         );
  CKMUX2D0BWP12T30P140 U7 ( .I0(SRAM_IN[7]), .I1(IR_OUT_1[3]), .S(LI), .Z(n8)
         );
  CKMUX2D0BWP12T30P140 U8 ( .I0(SRAM_IN[6]), .I1(IR_OUT_1[2]), .S(LI), .Z(n7)
         );
  CKMUX2D0BWP12T30P140 U9 ( .I0(SRAM_IN[4]), .I1(IR_OUT_1[0]), .S(LI), .Z(n5)
         );
  CKMUX2D0BWP12T30P140 U10 ( .I0(SRAM_IN[5]), .I1(IR_OUT_1[1]), .S(LI), .Z(n6)
         );
  AN2D0BWP12T30P140 U11 ( .A1(IR_OUT_r[3]), .A2(EI), .Z(IR_OUT_2[3]) );
  AN2D0BWP12T30P140 U12 ( .A1(IR_OUT_r[2]), .A2(EI), .Z(IR_OUT_2[2]) );
  AN2D0BWP12T30P140 U13 ( .A1(IR_OUT_r[1]), .A2(EI), .Z(IR_OUT_2[1]) );
  AN2D0BWP12T30P140 U14 ( .A1(IR_OUT_r[0]), .A2(EI), .Z(IR_OUT_2[0]) );
endmodule
...
module ADDR_ROM ( IR_OUT, AR_OUT );
  ...
  OAI21D0BWP12T30P140 U5 ( .A1(IR_OUT[0]), .A2(n1), .B(n3), .ZN(AR_OUT[3]) );
  ND3D0BWP12T30P140 U6 ( .A1(IR_OUT[0]), .A2(n3), .A3(IR_OUT[1]), .ZN(
        AR_OUT[2]) );
  OAI21D0BWP12T30P140 U7 ( .A1(IR_OUT[1]), .A2(n2), .B(n3), .ZN(AR_OUT[1]) );
...
module MICRO_PROG_COUNTER ( clk, rst, AR_ROM_IN, LOAD_MICRO, INC_MICRO, 
  ...
  DFCNQD1BWP12T30P140 PRE_OUT_r_reg_0_ ( .D(n10), .CP(clk), .CDN(n5), .Q(
        PRE_OUT[0]) );
  IND2D1BWP12T30P140 U3 ( .A1(LOAD_MICRO), .B1(INC_MICRO), .ZN(n24) );
  INVD0BWP12T30P140 U4 ( .I(n24), .ZN(n2) );
  ND3D0BWP12T30P140 U5 ( .A1(PRE_OUT[1]), .A2(PRE_OUT[0]), .A3(PRE_OUT[2]), 
        .ZN(n1) );
  NR3D0BWP12T30P140 U6 ( .A1(LOAD_MICRO), .A2(INC_MICRO), .A3(CLEAR_MICRO), 
        .ZN(n22) );
  AOI21D0BWP12T30P140 U7 ( .A1(n2), .A2(n1), .B(n22), .ZN(n17) );
  INVD0BWP12T30P140 U8 ( .I(PRE_OUT[3]), .ZN(n21) );
  ND4D0BWP12T30P140 U9 ( .A1(n2), .A2(PRE_OUT[1]), .A3(PRE_OUT[0]), .A4(
        PRE_OUT[2]), .ZN(n20) );
  MAOI22D0BWP12T30P140 U10 ( .A1(LOAD_MICRO), .A2(AR_ROM_IN[3]), .B1(
        PRE_OUT[3]), .B2(n20), .ZN(n3) );
  OAI21D0BWP12T30P140 U11 ( .A1(n17), .A2(n21), .B(n3), .ZN(n7) );
  IAO21D0BWP12T30P140 U12 ( .A1(n24), .A2(PRE_OUT[0]), .B(n22), .ZN(n13) );
  INVD0BWP12T30P140 U13 ( .I(PRE_OUT[1]), .ZN(n12) );
  NR2D0BWP12T30P140 U14 ( .A1(PRE_OUT[1]), .A2(n24), .ZN(n4) );
  AOI22D0BWP12T30P140 U15 ( .A1(LOAD_MICRO), .A2(AR_ROM_IN[1]), .B1(PRE_OUT[0]), .B2(n4), .ZN(n11) );
  OAI21D0BWP12T30P140 U16 ( .A1(n13), .A2(n12), .B(n11), .ZN(n9) );
  ND2D0BWP12T30P140 U17 ( .A1(PRE_OUT[1]), .A2(PRE_OUT[0]), .ZN(n16) );
  OAI21D0BWP12T30P140 U18 ( .A1(PRE_OUT[1]), .A2(n24), .B(n13), .ZN(n14) );
  AOI22D0BWP12T30P140 U19 ( .A1(LOAD_MICRO), .A2(AR_ROM_IN[2]), .B1(PRE_OUT[2]), .B2(n14), .ZN(n15) );
  OAI31D0BWP12T30P140 U20 ( .A1(PRE_OUT[2]), .A2(n24), .A3(n16), .B(n15), .ZN(
        n8) );
  OAI21D0BWP12T30P140 U21 ( .A1(PRE_OUT[3]), .A2(n24), .B(n17), .ZN(n18) );
  AOI22D0BWP12T30P140 U22 ( .A1(LOAD_MICRO), .A2(AR_ROM_IN[4]), .B1(PRE_OUT[4]), .B2(n18), .ZN(n19) );
  OAI31D0BWP12T30P140 U23 ( .A1(PRE_OUT[4]), .A2(n21), .A3(n20), .B(n19), .ZN(
        n6) );
  AOI22D0BWP12T30P140 U24 ( .A1(LOAD_MICRO), .A2(AR_ROM_IN[0]), .B1(PRE_OUT[0]), .B2(n22), .ZN(n23) );
  OAI21D0BWP12T30P140 U25 ( .A1(PRE_OUT[0]), .A2(n24), .B(n23), .ZN(n10) );
...
module MICROCODE_ROM ( PRE_IN, ROM_OUT );
  ...
  INVD0BWP12T30P140 U4 ( .I(PRE_IN[1]), .ZN(n17) );
  AOI221D0BWP12T30P140 U5 ( .A1(PRE_IN[1]), .A2(n12), .B1(n17), .B2(PRE_IN[0]), 
        .C(PRE_IN[2]), .ZN(n4) );
  ND2D0BWP12T30P140 U6 ( .A1(n17), .A2(PRE_IN[2]), .ZN(n5) );
  INVD0BWP12T30P140 U7 ( .I(n5), .ZN(n13) );
  INVD0BWP12T30P140 U8 ( .I(PRE_IN[3]), .ZN(n10) );
  NR2D0BWP12T30P140 U9 ( .A1(PRE_IN[4]), .A2(n10), .ZN(n14) );
  INVD0BWP12T30P140 U10 ( .I(n14), .ZN(n2) );
  ND3D0BWP12T30P140 U11 ( .A1(n12), .A2(PRE_IN[1]), .A3(PRE_IN[4]), .ZN(n3) );
  OAI31D0BWP12T30P140 U12 ( .A1(n4), .A2(n13), .A3(n2), .B(n3), .ZN(ROM_OUT[3]) );
  INVD0BWP12T30P140 U13 ( .I(n3), .ZN(n7) );
  AOI21D0BWP12T30P140 U14 ( .A1(PRE_IN[2]), .A2(n10), .B(PRE_IN[4]), .ZN(n6)
         );
  ND2D0BWP12T30P140 U15 ( .A1(n4), .A2(n14), .ZN(n15) );
  OAI211D0BWP12T30P140 U16 ( .A1(n7), .A2(n6), .B(n15), .C(n5), .ZN(ROM_OUT[2]) );
...
module NANOCODE_ROM ( NANO_PRE_IN, NANO_ROM_OUT );
  ...
  INVD0BWP12T30P140 U6 ( .I(NANO_PRE_IN[2]), .ZN(n5) );
  ND3D0BWP12T30P140 U7 ( .A1(n7), .A2(n5), .A3(NANO_PRE_IN[0]), .ZN(n1) );
  ...
  CKND2D1BWP12T30P140 U11 ( .A1(n2), .A2(n6), .ZN(NANO_ROM_OUT[14]) );
  NR2D0BWP12T30P140 U12 ( .A1(NANO_PRE_IN[2]), .A2(NANO_ROM_OUT[14]), .ZN(
        NANO_ROM_OUT[16]) );
  NR2D0BWP12T30P140 U13 ( .A1(NANO_PRE_IN[1]), .A2(n1), .ZN(NANO_ROM_OUT[15])
         );
  CKND2D1BWP12T30P140 U14 ( .A1(NANO_PRE_IN[1]), .A2(n2), .ZN(n4) );
  OR2D0BWP12T30P140 U15 ( .A1(n4), .A2(NANO_PRE_IN[2]), .Z(NANO_ROM_OUT[12])
         );
  ND3D0BWP12T30P140 U16 ( .A1(n7), .A2(NANO_PRE_IN[0]), .A3(NANO_PRE_IN[2]), 
        .ZN(n3) );
  AN2D0BWP12T30P140 U17 ( .A1(n3), .A2(NANO_ROM_OUT[12]), .Z(NANO_ROM_OUT[13])
         );
  NR2D0BWP12T30P140 U18 ( .A1(n5), .A2(NANO_ROM_OUT[14]), .ZN(NANO_ROM_OUT[11]) );
  OAI211D0BWP12T30P140 U19 ( .A1(NANO_PRE_IN[2]), .A2(NANO_PRE_IN[3]), .B(
        NANO_PRE_IN[0]), .C(n6), .ZN(NANO_ROM_OUT[9]) );
  INVD0BWP12T30P140 U20 ( .I(NANO_ROM_OUT[3]), .ZN(NANO_ROM_OUT[8]) );
  NR2D0BWP12T30P140 U21 ( .A1(n5), .A2(n4), .ZN(NANO_ROM_OUT[1]) );
  NR2D0BWP12T30P140 U22 ( .A1(NANO_ROM_OUT[1]), .A2(NANO_ROM_OUT[10]), .ZN(
        NANO_ROM_OUT[0]) );
  NR3D0BWP12T30P140 U23 ( .A1(NANO_PRE_IN[0]), .A2(n7), .A3(n6), .ZN(
        NANO_ROM_OUT[7]) );
  ND4D0BWP12T30P140 U24 ( .A1(NANO_PRE_IN[2]), .A2(NANO_PRE_IN[1]), .A3(
        NANO_PRE_IN[0]), .A4(n7), .ZN(NANO_ROM_OUT[4]) );
  INR3D1BWP12T30P140 U25 ( .A1(NANO_PRE_IN[0]), .B1(NANO_PRE_IN[1]), .B2(n7), 
        .ZN(NANO_ROM_OUT[5]) );
  NR3D0BWP12T30P140 U26 ( .A1(NANO_PRE_IN[1]), .A2(NANO_PRE_IN[0]), .A3(n7), 
        .ZN(NANO_ROM_OUT[6]) );
endmodule
...
module ACC ( clk, ACC_IN, LA, EA, ACC_ALU, ACC_BUS );
  ...
  AN2D0BWP12T30P140 U2 ( .A1(ACC_ALU[0]), .A2(EA), .Z(ACC_BUS[0]) );
  AN2D0BWP12T30P140 U3 ( .A1(ACC_ALU[2]), .A2(EA), .Z(ACC_BUS[2]) );
  AN2D0BWP12T30P140 U4 ( .A1(ACC_ALU[3]), .A2(EA), .Z(ACC_BUS[3]) );
  AN2D0BWP12T30P140 U5 ( .A1(ACC_ALU[4]), .A2(EA), .Z(ACC_BUS[4]) );
  AN2D0BWP12T30P140 U6 ( .A1(ACC_ALU[5]), .A2(EA), .Z(ACC_BUS[5]) );
  AN2D0BWP12T30P140 U7 ( .A1(ACC_ALU[6]), .A2(EA), .Z(ACC_BUS[6]) );
  AN2D0BWP12T30P140 U8 ( .A1(ACC_ALU[7]), .A2(EA), .Z(ACC_BUS[7]) );
  AN2D0BWP12T30P140 U9 ( .A1(ACC_ALU[8]), .A2(EA), .Z(ACC_BUS[8]) );
  AN2D0BWP12T30P140 U10 ( .A1(ACC_ALU[1]), .A2(EA), .Z(ACC_BUS[1]) );
  CKMUX2D0BWP12T30P140 U11 ( .I0(ACC_IN[4]), .I1(ACC_ALU[4]), .S(LA), .Z(n5)
         );
  CKMUX2D0BWP12T30P140 U12 ( .I0(ACC_IN[5]), .I1(ACC_ALU[5]), .S(LA), .Z(n6)
         );
  CKMUX2D0BWP12T30P140 U13 ( .I0(ACC_IN[6]), .I1(ACC_ALU[6]), .S(LA), .Z(n7)
         );
  CKMUX2D0BWP12T30P140 U14 ( .I0(ACC_IN[7]), .I1(ACC_ALU[7]), .S(LA), .Z(n8)
         );
  CKMUX2D0BWP12T30P140 U15 ( .I0(ACC_IN[1]), .I1(ACC_ALU[1]), .S(LA), .Z(n2)
         );
  CKMUX2D0BWP12T30P140 U16 ( .I0(ACC_IN[3]), .I1(ACC_ALU[3]), .S(LA), .Z(n4)
         );
  CKMUX2D0BWP12T30P140 U17 ( .I0(ACC_IN[8]), .I1(ACC_ALU[8]), .S(LA), .Z(n9)
         );
  CKMUX2D0BWP12T30P140 U18 ( .I0(ACC_IN[2]), .I1(ACC_ALU[2]), .S(LA), .Z(n3)
         );
  CKMUX2D0BWP12T30P140 U19 ( .I0(ACC_IN[0]), .I1(ACC_ALU[0]), .S(LA), .Z(n1)
         );
endmodule
...
module BREG ( clk, B_IN, LB, B_OUT );
  ...
  CKMUX2D0BWP12T30P140 U2 ( .I0(B_IN[6]), .I1(B_OUT[6]), .S(LB), .Z(n7) );
  CKMUX2D0BWP12T30P140 U3 ( .I0(B_IN[7]), .I1(B_OUT[7]), .S(LB), .Z(n8) );
  CKMUX2D0BWP12T30P140 U4 ( .I0(B_IN[0]), .I1(B_OUT[0]), .S(LB), .Z(n1) );
  CKMUX2D0BWP12T30P140 U5 ( .I0(B_IN[1]), .I1(B_OUT[1]), .S(LB), .Z(n2) );
  CKMUX2D0BWP12T30P140 U6 ( .I0(B_IN[2]), .I1(B_OUT[2]), .S(LB), .Z(n3) );
  CKMUX2D0BWP12T30P140 U7 ( .I0(B_IN[3]), .I1(B_OUT[3]), .S(LB), .Z(n4) );
  CKMUX2D0BWP12T30P140 U8 ( .I0(B_IN[4]), .I1(B_OUT[4]), .S(LB), .Z(n5) );
  CKMUX2D0BWP12T30P140 U9 ( .I0(B_IN[5]), .I1(B_OUT[5]), .S(LB), .Z(n6) );
...
module ALU ( ALU_A, ALU_B, SU, AD, EU, ALU_OUT );
  ...
  wire   C2_DATA2_0, C2_DATA2_1, C2_DATA2_2, C2_DATA2_3, C2_DATA2_4,
         C2_DATA2_5, C2_DATA2_6, C2_DATA2_7, C2_DATA2_8, n1,
         ...
         DP_OP_14J1_122_1525_n3, DP_OP_14J1_122_1525_n2, n2, n3;
  wire   [8:0] ALU_OUT_w;

  CKMUX2D0BWP12T30P140 U13 ( .I0(C2_DATA2_8), .I1(ALU_OUT_w[8]), .S(n1), .Z(
        ALU_OUT_w[8]) );
  CKMUX2D0BWP12T30P140 U14 ( .I0(C2_DATA2_7), .I1(ALU_OUT_w[7]), .S(n1), .Z(
        ALU_OUT_w[7]) );
  CKMUX2D0BWP12T30P140 U15 ( .I0(C2_DATA2_6), .I1(ALU_OUT_w[6]), .S(n1), .Z(
        ALU_OUT_w[6]) );
  CKMUX2D0BWP12T30P140 U16 ( .I0(C2_DATA2_5), .I1(ALU_OUT_w[5]), .S(n1), .Z(
        ALU_OUT_w[5]) );
  CKMUX2D0BWP12T30P140 U17 ( .I0(C2_DATA2_4), .I1(ALU_OUT_w[4]), .S(n1), .Z(
        ALU_OUT_w[4]) );
  CKMUX2D0BWP12T30P140 U18 ( .I0(C2_DATA2_3), .I1(ALU_OUT_w[3]), .S(n1), .Z(
        ALU_OUT_w[3]) );
  CKMUX2D0BWP12T30P140 U19 ( .I0(C2_DATA2_2), .I1(ALU_OUT_w[2]), .S(n1), .Z(
        ALU_OUT_w[2]) );
  CKMUX2D0BWP12T30P140 U20 ( .I0(C2_DATA2_1), .I1(ALU_OUT_w[1]), .S(n1), .Z(
        ALU_OUT_w[1]) );
  CKMUX2D0BWP12T30P140 U21 ( .I0(C2_DATA2_0), .I1(ALU_OUT_w[0]), .S(n1), .Z(
        ALU_OUT_w[0]) );
  FA1D0BWP12T30P140 DP_OP_14J1_122_1525_U10 ( .A(SU), .B(ALU_A[0]), .CI(
        DP_OP_14J1_122_1525_n22), .CO(DP_OP_14J1_122_1525_n9), .S(C2_DATA2_0)
         );
  ...
  NR2D0BWP12T30P140 U2 ( .A1(SU), .A2(AD), .ZN(n1) );
  XOR2D1BWP12T30P140 U3 ( .A1(SU), .A2(ALU_B[1]), .Z(DP_OP_14J1_122_1525_n21)
         );
  XOR2D1BWP12T30P140 U4 ( .A1(SU), .A2(ALU_B[2]), .Z(DP_OP_14J1_122_1525_n20)
         );
  XOR2D1BWP12T30P140 U5 ( .A1(SU), .A2(ALU_B[3]), .Z(DP_OP_14J1_122_1525_n19)
         );
  XOR2D1BWP12T30P140 U6 ( .A1(SU), .A2(ALU_B[4]), .Z(DP_OP_14J1_122_1525_n18)
         );
  XOR2D1BWP12T30P140 U7 ( .A1(SU), .A2(ALU_B[5]), .Z(DP_OP_14J1_122_1525_n17)
         );
  XOR2D1BWP12T30P140 U8 ( .A1(SU), .A2(ALU_B[6]), .Z(DP_OP_14J1_122_1525_n16)
         );
  XOR2D1BWP12T30P140 U9 ( .A1(SU), .A2(ALU_B[7]), .Z(DP_OP_14J1_122_1525_n15)
         );
  XOR2D1BWP12T30P140 U10 ( .A1(SU), .A2(ALU_B[0]), .Z(DP_OP_14J1_122_1525_n22)
         );
  XOR2D1BWP12T30P140 U11 ( .A1(SU), .A2(ALU_B[8]), .Z(n2) );
  XOR2D1BWP12T30P140 U12 ( .A1(n2), .A2(ALU_A[8]), .Z(n3) );
  XOR2D1BWP12T30P140 U22 ( .A1(n3), .A2(DP_OP_14J1_122_1525_n2), .Z(C2_DATA2_8) );
  AN2D0BWP12T30P140 U23 ( .A1(ALU_OUT_w[0]), .A2(EU), .Z(ALU_OUT[0]) );
  AN2D0BWP12T30P140 U24 ( .A1(ALU_OUT_w[1]), .A2(EU), .Z(ALU_OUT[1]) );
  AN2D0BWP12T30P140 U25 ( .A1(ALU_OUT_w[2]), .A2(EU), .Z(ALU_OUT[2]) );
  AN2D0BWP12T30P140 U26 ( .A1(ALU_OUT_w[3]), .A2(EU), .Z(ALU_OUT[3]) );
  AN2D0BWP12T30P140 U27 ( .A1(ALU_OUT_w[4]), .A2(EU), .Z(ALU_OUT[4]) );
  AN2D0BWP12T30P140 U28 ( .A1(ALU_OUT_w[5]), .A2(EU), .Z(ALU_OUT[5]) );
  AN2D0BWP12T30P140 U29 ( .A1(ALU_OUT_w[6]), .A2(EU), .Z(ALU_OUT[6]) );
  AN2D0BWP12T30P140 U30 ( .A1(ALU_OUT_w[7]), .A2(EU), .Z(ALU_OUT[7]) );
  AN2D0BWP12T30P140 U31 ( .A1(ALU_OUT_w[8]), .A2(EU), .Z(ALU_OUT[8]) );
endmodule
...
module OREG ( clk, O_IN, LO, O_OUT );
  ...
  CKMUX2D0BWP12T30P140 U3 ( .I0(O_IN[2]), .I1(O_OUT[2]), .S(LO), .Z(n3) );
  CKMUX2D0BWP12T30P140 U4 ( .I0(O_IN[3]), .I1(O_OUT[3]), .S(LO), .Z(n4) );
  CKMUX2D0BWP12T30P140 U5 ( .I0(O_IN[4]), .I1(O_OUT[4]), .S(LO), .Z(n5) );
  CKMUX2D0BWP12T30P140 U6 ( .I0(O_IN[5]), .I1(O_OUT[5]), .S(LO), .Z(n6) );
  CKMUX2D0BWP12T30P140 U7 ( .I0(O_IN[6]), .I1(O_OUT[6]), .S(LO), .Z(n7) );
  CKMUX2D0BWP12T30P140 U8 ( .I0(O_IN[7]), .I1(O_OUT[7]), .S(LO), .Z(n8) );
  CKMUX2D0BWP12T30P140 U9 ( .I0(O_IN[8]), .I1(O_OUT[8]), .S(LO), .Z(n9) );
  CKMUX2D0BWP12T30P140 U10 ( .I0(O_IN[1]), .I1(O_OUT[1]), .S(LO), .Z(n2) );
endmodule
...
module M3CPU8 ( clk, rst, PC_o, MAR_o, SRAM_o, IR_o_1, IR_o_2, AR_o, PRE_o, 
  ...
  OR2D0BWP12T30P140 U19 ( .A1(PC_o[1]), .A2(IR_o_2[1]), .Z(n_0_net__1_) );
  OR2D0BWP12T30P140 U20 ( .A1(PC_o[2]), .A2(IR_o_2[2]), .Z(n_0_net__2_) );
  OR2D0BWP12T30P140 U21 ( .A1(PC_o[0]), .A2(IR_o_2[0]), .Z(n_0_net__0_) );
  OR2D0BWP12T30P140 U22 ( .A1(PC_o[3]), .A2(IR_o_2[3]), .Z(n_0_net__3_) );
  OR2D0BWP12T30P140 U23 ( .A1(SRAM_o[4]), .A2(ALU_out[4]), .Z(n_1_net__4_) );
  OR2D0BWP12T30P140 U24 ( .A1(SRAM_o[5]), .A2(ALU_out[5]), .Z(n_1_net__5_) );
  OR2D0BWP12T30P140 U25 ( .A1(SRAM_o[6]), .A2(ALU_out[6]), .Z(n_1_net__6_) );
  OR2D0BWP12T30P140 U26 ( .A1(SRAM_o[7]), .A2(ALU_out[7]), .Z(n_1_net__7_) );
  OR2D0BWP12T30P140 U27 ( .A1(SRAM_o[1]), .A2(ALU_out[1]), .Z(n_1_net__1_) );
  OR2D0BWP12T30P140 U28 ( .A1(SRAM_o[3]), .A2(ALU_out[3]), .Z(n_1_net__3_) );
  OR2D0BWP12T30P140 U29 ( .A1(SRAM_o[8]), .A2(ALU_out[8]), .Z(n_1_net__8_) );
  OR2D0BWP12T30P140 U30 ( .A1(SRAM_o[2]), .A2(ALU_out[2]), .Z(n_1_net__2_) );
  OR2D0BWP12T30P140 U31 ( .A1(SRAM_o[0]), .A2(ALU_out[0]), .Z(n_1_net__0_) );
  CKBD0BWP12T30P140 U32 ( .I(clk), .Z(n6) );
  CKBD0BWP12T30P140 U33 ( .I(clk), .Z(n5) );
endmodule
