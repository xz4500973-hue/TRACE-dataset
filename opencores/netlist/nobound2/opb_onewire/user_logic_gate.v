...
module user_logic ( DQ_Wire_I, DQ_Wire_O, DQ_Wire_T, main_fifty_clock, 
  ...
  output DQ_Wire_O, DQ_Wire_T, IP2Bus_Ack, IP2Bus_Retry, IP2Bus_Error,
         IP2Bus_ToutSup;
  wire   onewire_status_register_31_, slv_reg3_31_, primary_clock, N188, N189,
         N190, N191, N192, primary_clock_div_by_two, read_shutdown_one,
         onewire_received_bit, N368, N369, N370, n436, n437, n438, n439, n440,
  ...
  DFQD2BWP12T30P140 onewire_inject_opcode_reg_2_ ( .D(N370), .CP(n556), .Q(
  ...
  DFQD2BWP12T30P140 slv_reg2_reg_0_ ( .D(n548), .CP(Bus2IP_Clk), .Q(
        slv_reg2[0]) );
  DFQD2BWP12T30P140 slv_reg2_reg_1_ ( .D(n547), .CP(Bus2IP_Clk), .Q(
        slv_reg2[1]) );
  DFQD2BWP12T30P140 slv_reg2_reg_2_ ( .D(n546), .CP(Bus2IP_Clk), .Q(
        slv_reg2[2]) );
  DFQD2BWP12T30P140 slv_reg2_reg_3_ ( .D(n545), .CP(Bus2IP_Clk), .Q(
        slv_reg2[3]) );
  ...
  DFQD2BWP12T30P140 onewire_timer_reg_9_ ( .D(n438), .CP(primary_clock), .Q(
        onewire_timer[9]) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_2_ ( .D(N190), .CP(
  ...
  DFQD2BWP12T30P140 primary_clock_divider_reg_1_ ( .D(N189), .CP(
        main_fifty_clock), .Q(primary_clock_divider[1]) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_4_ ( .D(N192), .CP(
  ...
  DFQD2BWP12T30P140 onewire_inject_opcode_reg_0_ ( .D(N368), .CP(n556), .Q(
  ...
  DFQD2BWP12T30P140 read_shutdown_one_reg ( .D(n467), .CP(n556), .Q(
        read_shutdown_one) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_0_ ( .D(N188), .CP(
  ...
  DFQD2BWP12T30P140 byte_opcode_reg_1_ ( .D(n464), .CP(n556), .Q(
        byte_opcode[1]) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_3_ ( .D(N191), .CP(
        main_fifty_clock), .Q(primary_clock_divider[3]) );
  DFQD2BWP12T30P140 write_byte_reg_7_ ( .D(n452), .CP(n871), .Q(write_byte[7])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_4_ ( .D(n544), .CP(n873), .Q(slv_reg2[4]) );
  DFQD2BWP12T30P140 slv_reg2_reg_6_ ( .D(n542), .CP(n873), .Q(slv_reg2[6]) );
  DFQD2BWP12T30P140 slv_reg2_reg_7_ ( .D(n541), .CP(n873), .Q(slv_reg2[7]) );
  DFQD2BWP12T30P140 slv_reg2_reg_8_ ( .D(n540), .CP(n873), .Q(slv_reg2[8]) );
  DFQD2BWP12T30P140 slv_reg2_reg_9_ ( .D(n539), .CP(n873), .Q(slv_reg2[9]) );
  DFQD2BWP12T30P140 slv_reg2_reg_10_ ( .D(n538), .CP(n873), .Q(slv_reg2[10])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_11_ ( .D(n537), .CP(n873), .Q(slv_reg2[11])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_12_ ( .D(n536), .CP(n873), .Q(slv_reg2[12])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_13_ ( .D(n535), .CP(n873), .Q(slv_reg2[13])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_14_ ( .D(n534), .CP(n873), .Q(slv_reg2[14])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_15_ ( .D(n533), .CP(n873), .Q(slv_reg2[15])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_16_ ( .D(n532), .CP(n872), .Q(slv_reg2[16])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_17_ ( .D(n531), .CP(n872), .Q(slv_reg2[17])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_18_ ( .D(n530), .CP(n872), .Q(slv_reg2[18])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_19_ ( .D(n529), .CP(n872), .Q(slv_reg2[19])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_21_ ( .D(n527), .CP(n872), .Q(slv_reg2[21])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_22_ ( .D(n526), .CP(n872), .Q(slv_reg2[22])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_23_ ( .D(n525), .CP(n872), .Q(slv_reg2[23])
         );
  ...
  DFQD2BWP12T30P140 slv_reg2_reg_24_ ( .D(n524), .CP(n872), .Q(slv_reg2[24])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_25_ ( .D(n523), .CP(n872), .Q(slv_reg2[25])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_26_ ( .D(n522), .CP(n872), .Q(slv_reg2[26])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_27_ ( .D(n521), .CP(n872), .Q(slv_reg2[27])
         );
  DFQD2BWP12T30P140 slv_reg2_reg_28_ ( .D(n520), .CP(Bus2IP_Clk), .Q(
        slv_reg2[28]) );
  DFQD2BWP12T30P140 onewire_timer_reg_8_ ( .D(n439), .CP(primary_clock), .Q(
        onewire_timer[8]) );
  DFQD2BWP12T30P140 slv_reg2_reg_31_ ( .D(n517), .CP(n871), .Q(slv_reg2[31])
         );
  ...
  DFQD2BWP12T30P140 slv_reg2_reg_29_ ( .D(n519), .CP(Bus2IP_Clk), .Q(
        slv_reg2[29]) );
  DFQD2BWP12T30P140 slv_reg2_reg_30_ ( .D(n518), .CP(Bus2IP_Clk), .Q(
        slv_reg2[30]) );
  ...
  DFQD1BWP12T30P140 onewire_inject_opcode_reg_1_ ( .D(N369), .CP(
        primary_clock_div_by_two), .Q(onewire_inject_opcode[1]) );
  DFQD1BWP12T30P140 slv_reg2_reg_5_ ( .D(n543), .CP(n873), .Q(slv_reg2[5]) );
  DFQD1BWP12T30P140 slv_reg2_reg_20_ ( .D(n528), .CP(n872), .Q(slv_reg2[20])
         );
  ...
  NR2D0BWP12T30P140 U790 ( .A1(n574), .A2(n575), .ZN(N370) );
  IND2D1BWP12T30P140 U791 ( .A1(n736), .B1(n575), .ZN(n732) );
  IND2D1BWP12T30P140 U792 ( .A1(N370), .B1(byte_opcode[1]), .ZN(n577) );
  ...
  AO22D0BWP12T30P140 U948 ( .A1(Bus2IP_Data[2]), .A2(n673), .B1(slv_reg1[2]), 
        .B2(n672), .Z(n514) );
  NR2D0BWP12T30P140 U949 ( .A1(primary_clock_divider[0]), .A2(n867), .ZN(N188)
         );
  ...
  OAI21D0BWP12T30P140 U1004 ( .A1(n774), .A2(n860), .B(n859), .ZN(N368) );
  ...
  AOI221D0BWP12T30P140 U1012 ( .A1(primary_clock_divider[3]), .A2(
        ...
        primary_clock_divider[5]), .ZN(N192) );
  ...
  OA211D0BWP12T30P140 U1016 ( .A1(primary_clock_divider[1]), .A2(
        primary_clock_divider[0]), .B(n705), .C(n724), .Z(N189) );
  ...
  OAI33D0BWP12T30P140 U1051 ( .A1(n736), .A2(N370), .A3(n735), .B1(n734), .B2(
  ...
  AO22D0BWP12T30P140 U1085 ( .A1(Bus2IP_Data[29]), .A2(n790), .B1(slv_reg2[29]), .B2(n789), .Z(n519) );
  AO22D0BWP12T30P140 U1086 ( .A1(Bus2IP_Data[2]), .A2(n798), .B1(slv_reg2[2]), 
        .B2(n797), .Z(n546) );
  AO22D0BWP12T30P140 U1087 ( .A1(Bus2IP_Data[30]), .A2(n790), .B1(slv_reg2[30]), .B2(n789), .Z(n518) );
  ...
  IND4D1BWP12T30P140 U1090 ( .A1(Bus2IP_WrCE[0]), .B1(Bus2IP_WrCE[3]), .B2(
        Bus2IP_BE[3]), .B3(n847), .ZN(n795) );
  ...
  IOA21D0BWP12T30P140 U1166 ( .A1(n861), .A2(n860), .B(n859), .ZN(N369) );
