...
module debouncer_low_count250_1 ( enable, in, out, rising_pulse, falling_pulse, 
  ...
  wire   in_reg_0_, N35, N36, n15, n16, n17, n18, n19, n20, n21, n22, n23, n24,
         n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, n13, n14, n25, n26,
         n27, n28, n29, n30, n31, n32, n33, n34, n35, n36, n37, n38, n39, n40,
         n41, n42, n43, n44, n45, n46;
  wire   [8:0] counter;

  DFQD2BWP12T30P140 falling_pulse_reg ( .D(N36), .CP(clock), .Q(falling_pulse)
         );
  ...
  DFQD2BWP12T30P140 rising_pulse_reg ( .D(N35), .CP(clock), .Q(rising_pulse)
         );
  ...
  NR3D0BWP12T30P140 U48 ( .A1(out[0]), .A2(n46), .A3(n44), .ZN(N35) );
  NR3D0BWP12T30P140 U49 ( .A1(in_reg_0_), .A2(n46), .A3(n45), .ZN(N36) );
endmodule
...
module debouncer_low_count250_0 ( enable, in, out, rising_pulse, falling_pulse, 
  ...
  input enable, clock, reset;
  output rising_pulse, falling_pulse, valid;
  wire   in_reg_0_, N35, N36, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12,
  ...
  DFQD1BWP12T30P140 rising_pulse_reg ( .D(N35), .CP(clock), .Q(rising_pulse)
         );
