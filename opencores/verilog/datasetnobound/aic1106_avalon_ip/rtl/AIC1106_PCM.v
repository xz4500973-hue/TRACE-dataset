...
output                  coe_reset_n;
output                  coe_mute;
output   wire           coe_linsel;  // linear mode
...
// PCM state decoder
wire     fs_avalon_rdy_on;
assign fs_avalon_rdy_on  = (main_cnt == 9'd0);
wire     fs_avalon_rdy_off;
assign fs_avalon_rdy_off = (main_cnt == 9'd1);
wire     fs_txlatch;
assign   fs_txlatch       = (main_cnt == 9'd2);
wire     fs_pcmsyn1_on;
assign   fs_pcmsyn1_on    = (main_cnt == 9'd3);
wire     fs_pcmsyn1_off;
assign   fs_pcmsyn1_off   = (main_cnt == 9'd4);
wire     fs_shift1;
assign   fs_shift1        = ((main_cnt > 9'd4) && (main_cnt <= 9'd20));
wire     fs_rxlatch1;
assign   fs_rxlatch1      = (main_cnt == 9'd21);//21
wire     fs_pcmsyn2_on;
assign   fs_pcmsyn2_on    = (main_cnt == 9'd259);
wire     fs_pcmsyn2_off;
assign  fs_pcmsyn2_off    = (main_cnt == 9'd260);
wire     fs_shift2;
assign    fs_shift2       = ((main_cnt > 9'd260) && (main_cnt <= 9'd276));
wire     fs_rxlatch2;
assign    fs_rxlatch2      = (main_cnt == 9'd277);//277
wire     fs_rxvalid_off;
assign   fs_rxvalid_off   = (main_cnt == 9'd278);
