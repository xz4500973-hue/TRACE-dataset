...
`define INPUT640x512			"./input640x512RGB.raw"
`define INPUT1280x1024			"./input1280x1024RGB.raw"
`define INPUT1280x1024_21EXTRA	"./input640x512_21extraRGB.raw"	//21 extra pixels at the start to be discarded
...
//640x512 to 1280x1024
	...
	.outputFilename( "./output640x512to1280x1024.raw" ),
...
//640x512 to 640x512
	...
	.inputFilename( `INPUT640x512 ),
	.outputFilename( "./output640x512to640x512.raw" ),
...
//1280x1024 to 960x768
	...
	.outputFilename( "./output1280x1024to960x768.raw" ),
...
//1280x1024 to 640x512
	...
	.inputFilename( `INPUT1280x1024 ),
	.outputFilename( ".output1280x1024to640x512.raw" ),
...
//1280x1024 to 480x384
	...
	.inputFilename( `INPUT1280x1024 ),
	.outputFilename( "./output1280x1024to480x384.raw" ),
...
//640x512 to 1280x1024, discarding 21
	...
	.outputFilename( "./output640x512to1280x1024_21extra.raw" ),
...
//640x512 to 1280x1024, discarding 21
	...
	.inputFilename( `INPUT640x512 ),
	.outputFilename( "./output50x40to640x512clipped.raw" ),
