...
module user_logic ( DQ_Wire_I, DQ_Wire_O, DQ_Wire_T, main_fifty_clock, 
  ...
  output DQ_Wire_O, DQ_Wire_T, IP2Bus_Ack, IP2Bus_Retry, IP2Bus_Error,
         IP2Bus_ToutSup;
  wire   onewire_status_register_31_, slv_reg3_31_, primary_clock, N206, N207,
         N208, N209, N210, primary_clock_div_by_two, read_shutdown_one,
         onewire_received_bit, N386, N387, N388, n436, n437, n438, n439, n440,
  ...
  DFQD2BWP12T30P140 onewire_inject_opcode_reg_2_ ( .D(N388), .CP(n556), .Q(
  ...
  DFQD2BWP12T30P140 onewire_timer_reg_9_ ( .D(n438), .CP(primary_clock), .Q(
        onewire_timer[9]) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_2_ ( .D(N208), .CP(
  ...
  DFQD2BWP12T30P140 primary_clock_divider_reg_1_ ( .D(N207), .CP(
        main_fifty_clock), .Q(primary_clock_divider[1]) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_4_ ( .D(N210), .CP(
  ...
  DFQD2BWP12T30P140 onewire_inject_opcode_reg_0_ ( .D(N386), .CP(n556), .Q(
  ...
  DFQD2BWP12T30P140 read_shutdown_one_reg ( .D(n467), .CP(n556), .Q(
        read_shutdown_one) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_0_ ( .D(N206), .CP(
  ...
  DFQD2BWP12T30P140 byte_opcode_reg_1_ ( .D(n464), .CP(n556), .Q(
        byte_opcode[1]) );
  DFQD2BWP12T30P140 primary_clock_divider_reg_3_ ( .D(N209), .CP(
  ...
  DFQD1BWP12T30P140 onewire_inject_opcode_reg_1_ ( .D(N387), .CP(
  ...
  NR2D0BWP12T30P140 U790 ( .A1(n574), .A2(n575), .ZN(N388) );
  IND2D1BWP12T30P140 U791 ( .A1(n736), .B1(n575), .ZN(n732) );
  IND2D1BWP12T30P140 U792 ( .A1(N388), .B1(byte_opcode[1]), .ZN(n577) );
  ...
  AO22D0BWP12T30P140 U948 ( .A1(Bus2IP_Data[2]), .A2(n673), .B1(slv_reg1[2]), 
        .B2(n672), .Z(n514) );
  NR2D0BWP12T30P140 U949 ( .A1(primary_clock_divider[0]), .A2(n867), .ZN(N206)
         );
  ...
  OAI21D0BWP12T30P140 U1004 ( .A1(n774), .A2(n860), .B(n859), .ZN(N386) );
  ...
  AOI221D0BWP12T30P140 U1012 ( .A1(primary_clock_divider[3]), .A2(
        ...
        primary_clock_divider[5]), .ZN(N210) );
  ...
  OA211D0BWP12T30P140 U1016 ( .A1(primary_clock_divider[1]), .A2(
        primary_clock_divider[0]), .B(n705), .C(n724), .Z(N207) );
  ...
  OAI33D0BWP12T30P140 U1051 ( .A1(n736), .A2(N388), .A3(n735), .B1(n734), .B2(
  ...
  IOA21D0BWP12T30P140 U1166 ( .A1(n861), .A2(n860), .B(n859), .ZN(N387) );
