(* keep_hierarchy = "yes" *) module MC6803_gen2(
		input logic clk,
		RST,
		hold,
		halt,
...
(* keep_hierarchy = "yes" *) module MEM_128_8(input logic[6:0] address, input logic RW, Clk, reset, input logic[7:0] data_in, output logic[7:0] data_out);
