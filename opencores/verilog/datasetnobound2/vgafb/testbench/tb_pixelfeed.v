...
module tb_pixelfeed;
    ...
    vgafb_pixelfeed dut (
        ...
        .nbursts(18'd50),
        .baseaddress(26'd2048), .baseaddress_ack(),
        .fml_adr(fml_adr), .fml_stb(fml_stb), .fml_ack(fml_stb),
        .fml_di(fml_di), .dcb_stb(), .dcb_adr(), .dcb_dat(FML_di), .dcb_hit(1'b0),
    ...
    initial begin
        ...
        seed=12345; fml_di=64'h0; sys_rst=1; vga_rst=1;
        #20 sys_rst=0; #20 vga_rst=0;
        #30000;
