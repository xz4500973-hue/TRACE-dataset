/////////////////////////////////////////////////////////////////////
////  simple_spi testbench (variant 2): only cpol=0, cpha=0, e sweep 0..7
/////////////////////////////////////////////////////////////////////
`timescale 1ns / 1ps
...
module tst_bench_top();
	...
	initial begin
		...
		for (e=0; e<=7; e=e+1) begin
			force spi_slave.cpol=0; force spi_slave.cpha=0;
			u0.wb_write(1, SPCR, {4'b0101, 1'b0, 1'b0, e[1:0]});
			u0.wb_write(1, SPER, {6'h0, e[1:0]});
			for(n=0; n<16; n=n+1) begin
				u0.wb_write(1, SPDR, {4'h0, n[3:0]});
				u0.wb_read(1, SPSR, q);
		...
		#100000;
		$display("TB v2 doone at %0t", $time);
		$finish;
	end
endmodule