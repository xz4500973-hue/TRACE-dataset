...
module tb_usbh_host;
    ...
    reg utmi_txready, utmi_rxvalid, utmi_rxactive, utmi_rxerror;
    ...
    usbh_host u_dut(.clk_i(clk),.rst_i(rst),.cfg_awvalid_i(cfg_awvalid),.cfg_awaddr_i(cfg_awaddr),
    ...
    initial begin
        $dumpfile("usbh_host.vcd"); $dumpvars(0,tb_usbh_host);
        rst=1; cfg_awvalid=0;cfg_wvalid=0;cfg_bready=0;cfg_arvalid=0;cfg_rready=0;
        utmi_data_in=0; utmi_txready=1;utmi_rxvalid=0;utmi_rxactive=0;utmi_rxerror=0;utmi_linestate=2'b01;
        #100 rst=0; #200;
        for(i=0;i<20;i=i+1) begin #100; end
