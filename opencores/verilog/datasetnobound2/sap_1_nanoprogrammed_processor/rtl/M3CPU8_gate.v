...
module ALU ( ALU_A, ALU_B, SU, AD, EU, ALU_OUT );
  ...
  wire   C2_DATA2_0, C2_DATA2_1, C2_DATA2_2, C2_DATA2_3, C2_DATA2_4,
         C2_DATA2_5, C2_DATA2_6, C2_DATA2_7, DP_OP_14J1_122_1525_n22,
         DP_OP_14J1_122_1525_n21, DP_OP_14J1_122_1525_n20,
         DP_OP_14J1_122_1525_n19, DP_OP_14J1_122_1525_n18,
         DP_OP_14J1_122_1525_n17, DP_OP_14J1_122_1525_n16,
         DP_OP_14J1_122_1525_n15, DP_OP_14J1_122_1525_n9,
         DP_OP_14J1_122_1525_n8, DP_OP_14J1_122_1525_n7,
         DP_OP_14J1_122_1525_n6, DP_OP_14J1_122_1525_n5,
         DP_OP_14J1_122_1525_n4, DP_OP_14J1_122_1525_n3,
         DP_OP_14J1_122_1525_n2, n1, n2, n3, n4;
  ...
  CKXOR2D0BWP12T30P140 U2 ( .A1(SU), .A2(ALU_B[4]), .Z(DP_OP_14J1_122_1525_n18) );
  CKXOR2D0BWP12T30P140 U3 ( .A1(SU), .A2(ALU_B[5]), .Z(DP_OP_14J1_122_1525_n17) );
  CKXOR2D0BWP12T30P140 U4 ( .A1(SU), .A2(ALU_B[6]), .Z(DP_OP_14J1_122_1525_n16) );
  CKXOR2D0BWP12T30P140 U5 ( .A1(SU), .A2(ALU_B[7]), .Z(DP_OP_14J1_122_1525_n15) );
  CKXOR2D0BWP12T30P140 U6 ( .A1(SU), .A2(ALU_B[1]), .Z(DP_OP_14J1_122_1525_n21) );
  CKXOR2D0BWP12T30P140 U7 ( .A1(SU), .A2(ALU_B[2]), .Z(DP_OP_14J1_122_1525_n20) );
  CKXOR2D0BWP12T30P140 U8 ( .A1(SU), .A2(ALU_B[3]), .Z(DP_OP_14J1_122_1525_n19) );
  CKXOR2D0BWP12T30P140 U9 ( .A1(SU), .A2(ALU_B[0]), .Z(DP_OP_14J1_122_1525_n22) );
  OAI21D0BWP12T30P140 U10 ( .A1(SU), .A2(AD), .B(EU), .ZN(n3) );
  INR2D1BWP12T30P140 U11 ( .A1(C2_DATA2_0), .B1(n3), .ZN(ALU_OUT[0]) );
  INR2D1BWP12T30P140 U12 ( .A1(C2_DATA2_1), .B1(n3), .ZN(ALU_OUT[1]) );
  INR2D1BWP12T30P140 U13 ( .A1(C2_DATA2_2), .B1(n3), .ZN(ALU_OUT[2]) );
  INR2D1BWP12T30P140 U14 ( .A1(C2_DATA2_3), .B1(n3), .ZN(ALU_OUT[3]) );
  INR2D1BWP12T30P140 U15 ( .A1(C2_DATA2_4), .B1(n3), .ZN(ALU_OUT[4]) );
  INR2D1BWP12T30P140 U16 ( .A1(C2_DATA2_5), .B1(n3), .ZN(ALU_OUT[5]) );
  INR2D1BWP12T30P140 U17 ( .A1(C2_DATA2_6), .B1(n3), .ZN(ALU_OUT[6]) );
  INR2D1BWP12T30P140 U18 ( .A1(C2_DATA2_7), .B1(n3), .ZN(ALU_OUT[7]) );
  CKXOR2D0BWP12T30P140 U19 ( .A1(SU), .A2(ALU_B[8]), .Z(n1) );
  CKXOR2D0BWP12T30P140 U20 ( .A1(n1), .A2(ALU_A[8]), .Z(n2) );
  CKXOR2D0BWP12T30P140 U21 ( .A1(n2), .A2(DP_OP_14J1_122_1525_n2), .Z(n4) );
  INR2D1BWP12T30P140 U22 ( .A1(n4), .B1(n3), .ZN(ALU_OUT[8]) );
endmodule
