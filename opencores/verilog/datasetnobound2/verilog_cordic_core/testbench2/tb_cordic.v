...
module tb ();
  ...
  initial begin
    ...
    // Few angles: 0, 30, 60, 90 degrees
    for(j=0;j<4;j=j+1) begin
      case(j) 0: theta_i<=17'd0; 1: theta_i<=17'd17157; 2: theta_i<=17'd34314; 3: theta_i<=17'd51471; endcase
      x_i<=`CORDIC_1; y_i<=0;
      #1 clock<=1;#1 clock<=0;
    end

    for(i=0;i<(`ITERATIONS+10);i=i+1) begin #1 clock<=1;#1 clock<=0; end
