...
parameter fifo_depth     = 10;
  ...
  parameter GFX_CONTROL_LINE   = 550;
  parameter GFX_CONTROL_CD16   = 330;
...
initial begin
  ...
  wbs_adr_i  = GFX_CLIP_PIXEL0_X;
  #4 wbs_cyc_i = 0;

  #2 wbs_cyc_i = 1;
  wbs_dat_i  = 32'h00060008; // (115 << 16) | 115
  wbs_adr_i  = GFX_CLIP_PIXEL0_Y;
  #4 wbs_cyc_i = 0;
  ...
  #10 wbs_cyc_i = 1;
  wbs_dat_i  = 32'h00040004; // (110 << 16) | 110
  wbs_adr_i  = GFX_CLIP_PIXEL1_X;
  #4 wbs_cyc_i = 0;

  #2 wbs_cyc_i = 1;
  wbs_dat_i  = 32'h00020008; // (115 << 16) | 115
  wbs_adr_i  = GFX_CLIP_PIXEL1_Y;
  #4 wbs_cyc_i = 0;
