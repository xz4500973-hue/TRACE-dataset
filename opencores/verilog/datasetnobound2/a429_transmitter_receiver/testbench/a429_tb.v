...
module a429_tb_top;
    ...
    initial begin
        ...
        // ---------- Test mode 1: 12.5Kbps, counting data ----------
        $display("Mode 1: 12.5Kbps, incrementing data");
        speed = 2'b10;   // 12.5Kbps
        gap_bits = 7'd20;
        num_words = 120;
        ...
        // ---------- Test mode 2: 100Kbps rapid switching ----------
        $display("Mode 2: 100Kbps, alternating speed bursts");
        speed = 2'b00;
        gap_bits = 7'd10;
        num_words = 50;
        for (i=0; i<num_words; i=i+1) begin
