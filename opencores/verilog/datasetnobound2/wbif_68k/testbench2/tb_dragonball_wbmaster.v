...
module tb_dragonball_wbmaster;
    ...
    wire [adr_hi:1] adr_o;
    wire [1:0] sel_o;
    wire we_o; wire [15:0] dat_o;
    reg [15:0] wb_dat_i; reg ack_i, err_i;
    ...
    initial begin
        ...
        // Variant: word writes + mixed read-write interleaved
        for (i=0;i<60;i=i+1) begin
            addr = $random % (1<<adr_hi);
            wr(addr, $random%65536, 1'b1, 1'b1);
            if (i%3==0) begin addr=$random%(1<<adr_hi); rd(addr,rd_data); end
        end
