...
module tb_SSPx_Slv_v;
    reg Rst, SSEL, SCK, MOSI;
    wire MISO;
    wire [2:0] RA; wire WnR, En, EOC;
    wire [11:0] DI; reg [11:0] DO;
    wire [3:0] BC;
    integer i;
    ...
    task SSP; input [2:0] RAIn, Cmd; input [11:0] DIn, DOut;
      begin SSEL=1; MOSI=RAIn[2]; DO=DOut; #5 SCK=1;#5 SCK=0; MOSI=RAIn[1]; #5 SCK=1;#5 SCK=0; MOSI=RAIn[0];
            ...
            for(i=0;i<12;i=i+1)begin MOSI=DIn[11-i]; #5 SCK=1;#5 SCK=0; end
            SSEL=0; end endtask
    ...
    initial begin
        ...
        #50 Rst=0; #20;
        // Write/read loop
        for(i=0;i<40;i=i+1) begin SSP(i%8, i%2, i*256, i*128); #20; end
        #1000;
