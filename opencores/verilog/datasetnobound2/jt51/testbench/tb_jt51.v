...
module tb_jt51;
    ...
    initial begin
        ...
        test_vals = '{8'h00, 8'hFF, 8'h55, 8'hAA};
        for (idx = 0; idx < 500; idx = idx + 1) begin
            #50;
            write_jt51(8'h20, test_vals[idx % 4]);
            write_jt51(8'h21, test_vals[(idx+1) % 4]);
            write_jt51(8'h22, test_vals[(idx+2) % 4]);
            write_jt51(8'h23, test_vals[(idx+3) % 4]);
            write_jt51(8'h30, test_vals[(idx+1) % 4]);
            write_jt51(8'h31, test_vals[(idx+2) % 4]);
        end
        #500000;
        $finish;
    end
