...
always @(posedge clk) 
	if( ne ) begin
		if( zero_out )
			// if-else chain (was casex)
				if(eg[9]==1'b0) limit <= 10'h3FF;
				else if(eg[8]==1'b0) limit <= 10'h1FF;
				else if(eg[7]==1'b0) limit <= 10'h0FF;
				else if(eg[6]==1'b0) limit <= 10'h07F;
				else if(eg[5]==1'b0) limit <= 10'h03F;
				else if(eg[4]==1'b0) limit <= 10'h01F;
				else if(eg[3]==1'b0) limit <= 10'h00F;
				else if(eg[2]==1'b0) limit <= 10'h007;
				else if(eg[1]==1'b0) limit <= 10'h003;
				else limit <= 10'h001;		
	end
	else limit <= 10'd0;
