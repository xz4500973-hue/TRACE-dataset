...
always @(*) begin : calcpow2
	// if-else style (was case)
		if(pow2ind_IV==3'd0) pow2 <= 5'd16;
		else if(pow2ind_IV==3'd1) pow2 <= 5'd17;
		else if(pow2ind_IV==3'd2) pow2 <= 5'd19;
		else if(pow2ind_IV==3'd3) pow2 <= 5'd20;
		else if(pow2ind_IV==3'd4) pow2 <= 5'd22;
		else if(pow2ind_IV==3'd5) pow2 <= 5'd24;
		else if(pow2ind_IV==3'd6) pow2 <= 5'd26;
		else pow2 <= 5'd29;
end
...
always @(*) begin : dt1_limit_mux
	// if-else
		if(dt1_IV[1:0]==2'd0) dt1_limit <= 5'd8;
		else if(dt1_IV[1:0]==2'd1) dt1_limit <= 5'd8;
		else if(dt1_IV[1:0]==2'd2) dt1_limit <= 5'd16;
		else dt1_limit <= 5'd22;
	// dt1_kf block
		if(dt1_kf_IV==3'd0) dt1_unlimited <= { 5'd0, pow2[4]   }; // <2
		else if(dt1_kf_IV==3'd1) dt1_unlimited <= { 4'd0, pow2[4:3] }; // <4
		else if(dt1_kf_IV==3'd2) dt1_unlimited <= { 3'd0, pow2[4:2] }; // <8
		else if(dt1_kf_IV==3'd3) dt1_unlimited <= { 2'd0, pow2[4:1] };
		else if(dt1_kf_IV==3'd4) dt1_unlimited <= { 1'd0, pow2[4:0] };
		else if(dt1_kf_IV==3'd5) dt1_unlimited <= { pow2[4:0], 1'd0 };
		else dt1_unlimited <= 6'd0;
