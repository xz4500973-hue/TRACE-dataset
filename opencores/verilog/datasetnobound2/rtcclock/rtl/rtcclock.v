...
//
///////////////////////////////////////////////////////////////////////////
(* keep_hierarchy = "yes" *) module	rtcclock(i_clk, 
		// Wishbone interface
	...
	always @(posedge i_clk)
		if(i_wb_addr[2:0] == 3'b000)
			o_data <= { 6'h00, clock[25:22], ck_last_clock };
		else if(i_wb_addr[2:0] == 3'b001)
			o_data <= { 6'h00, timer };
		else if(i_wb_addr[2:0] == 3'b010)
			o_data <= stopwatch;
		else if(i_wb_addr[2:0] == 3'b011)
			o_data <= { 6'h00, al_tripped, al_enabled, 2'b00, alarm_time };
		else if(i_wb_addr[2:0] == 3'b100)
			o_data <= ckspeed;
		else if(i_wb_addr[2:0] == 3'b101)
			o_data <= { 2'b00, hack_time };
		else if(i_wb_addr[2:0] == 3'b110)
			o_data <= hack_counter[39:8];
		else if(i_wb_addr[2:0] == 3'b111)
			o_data <= { hack_counter[7:0], 24'h00 };
