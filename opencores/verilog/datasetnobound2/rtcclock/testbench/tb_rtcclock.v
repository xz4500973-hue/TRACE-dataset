...
module tb_rtcclock;
    ...
    initial begin
        ...
        wb_write(3'b000, {6'h00, 4'h0, 22'h120000}); // time = 12:00:00
        wb_write(3'b011, {6'h00, 1'b0, 1'b1, 2'b00, 22'h120005}); // alarm 12:00:05 enabled
        wb_write(3'b001, {6'h00, 2'b00, 24'h000030}); // timer = 30
