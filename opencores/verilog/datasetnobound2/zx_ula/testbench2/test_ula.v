...
module tb_ula;
    ...
    // Test procedure - variant 2: different initial state and timing
    initial begin
        // Generate VCD
        $dumpfile("ula.vcd");
        $dumpvars(0, tb_ula);

        // Initialize with inverted pattern
        vramdout = 8'b11001100;
        ear = 1;
        kbcolumns = 5'b11111;

        // Run shorter first segment
        #800_000;

        // Inject activity at different intervals
        ear = 0;
        kbcolumns = 5'b00110;
