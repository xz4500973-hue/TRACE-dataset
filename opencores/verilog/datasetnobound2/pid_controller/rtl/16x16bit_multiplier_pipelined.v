...
//Booth Encoder Array
(* keep_hierarchy = "yes" *) module booth_array(
...
*/
(* keep_hierarchy = "yes" *) module partial_product_gen(
...
(* keep_hierarchy = "yes" *) module	half_adder(
input	A,
input	B,
output	S,
output	carry
...
(* keep_hierarchy = "yes" *) module full_adder(
input	A,
input	B,
input	cin,
output	S,
...
(* keep_hierarchy = "yes" *) module	compressor42(
input	A,
input	B,
input	C,
input	D,
...
(* keep_hierarchy = "yes" *) module	multiplier_16x16bit_pipelined(
input	i_clk,
input	i_rst,
input	i_start,
input	[15:0]i_md,
