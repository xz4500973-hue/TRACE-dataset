...
initial begin
    ...
    sys_rst = 1; waitclock; sys_rst = 0; waitclock;

    csrwrite(32'h24, 32'h01000000); // dst addr
    csrwrite(32'h08, 32'd1);        // mesh count x = 1
    csrwrite(32'h10, 32'd1);        // mesh count y = 1
    csrwrite(32'h0c, 32'd20);       // mesh size x
    csrwrite(32'h14, 32'd20);       // mesh size y
    csrwrite(32'h00, 32'd1);        // start
