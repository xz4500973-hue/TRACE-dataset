...
initial begin
    ...
    // Enable mesh and set sizes
    csrwrite(32'h08,32'd2); csrwrite(32'h10,32'd2);
    csrwrite(32'h0c,32'd40); csrwrite(32'h14,32'd40);
    csrwrite(32'h24,32'h01000000);
