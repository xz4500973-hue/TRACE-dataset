...
(* keep_hierarchy = "yes" *) module hpdmc_mgmt #(
...
parameter ACTIVATE		= 7'b0000010;
parameter READ			= 7'b0000100;
parameter WRITE			= 7'b0001000;
parameter PRECHARGEALL		= 7'b0010000;
parameter AUTOREFRESH		= 7'b0100000;
parameter AUTOREFRESH_WAIT	= 7'b1000000;
...
always @(*) begin
	...
	case(1'b1) // one-hot synthesis
		...
		state[6]: begin // AUTOREFRESH_WAIT
			if(autorefresh_done)
				next_state = IDLE;
		end
