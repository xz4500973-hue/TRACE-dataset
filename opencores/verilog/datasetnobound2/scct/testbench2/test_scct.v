...
// Test bed for scct (variant 2: different preset values, longer simulation)
...
module test_scct;
   ...
   initial begin
      #0 rst = 1;
      #1 rst = 0;
      // Variant 2: different prescaler (2), IC_BOTHEDGE
      #1 address = `SCCT_PSC; writedata=32'd2; write=1; #3 write=0;
      #1 address = `SCCT_CH_MS; writedata={24'b0,6'b0,`SCCT_CH_MS_IC,`SCCT_CH_MS_IC}; write=1; #2 write=0;
      #2 address = `SCCT_CH_ACT; writedata={24'b0,4'b0,4'b1001}; write=1; #2 write=0;
      #2 address = `SCCT_CH_CCR1; writedata=32'h08; write=1; #2 write=0;
      #2 address = `SCCT_CH_IE; writedata=32'b11; write=1; #2 write=0;
      // Multiple input toggles
      #2 inp=1; #4 inp=0; #4 inp=1; #4 inp=0; #4 inp=1; #4 inp=0;
