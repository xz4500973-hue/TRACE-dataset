...
module PWM_tb;
    ...
    initial begin
        configdata[0]=32'h40303; configdata[1]=32'h600ed; configdata[2]=31'h17;
        configdata[3]=32'h80; configdata[4]=32'h20005; configdata[5]=32'h401a1;
        configdata[6]=32'h1c; configdata[7]=32'h80; configdata[8]=32'h20008;
        configdata[9]=32'h400aa; configdata[10]=32'h15;
    end
