(* keep_hierarchy = "yes" *) module	shift_1b(
input	i_shift,
input	[31:0]i_data,
output	[31:0]o_data
);
...
(* keep_hierarchy = "yes" *) module	shift_3b(
input	[2:0]i_shift,
input	[31:0]i_data,
output	[31:0]o_data
);
...
(* keep_hierarchy = "yes" *) module	shift_7b(
input	[6:0]i_shift,
input	[31:0]i_data,
output	[31:0]o_data
);
...
(* keep_hierarchy = "yes" *) module	shift_15b(
input	[14:0]i_shift,
input	[31:0]i_data,
output	[31:0]o_data
);
...
(* keep_hierarchy = "yes" *) module	shifter(
input	[31:0]i_data,
output	[31:0]o_data,
