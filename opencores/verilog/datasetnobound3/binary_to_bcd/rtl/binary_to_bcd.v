// VARIANT: Single merged always block with localparam state encoding
...
// VARIANT: FSM with localparam states, single merged always
localparam S_IDLE = 2'b00, S_BUSY = 2'b01;
