...
always @(posedge sys_clk) begin
	if(sys_rst) begin
		...
		if(csr_selected) begin
			...
			if(csr_a[3:0] == 4'b1010)
				csr_do <= {dmaw_remaining, 2'b00};
			else if(csr_a[3:0] == 4'b1001)
				csr_do <= {dmaw_addr, 2'b00};
			else if(csr_a[3:0] == 4'b1000)
				csr_do <= dmaw_en;
			else if(csr_a[3:0] == 4'b0110)
				csr_do <= {dmar_remaining, 2'b00};
			else if(csr_a[3:0] == 4'b0101)
				csr_do <= {dmar_addr, 2'b00};
			else if(csr_a[3:0] == 4'b0100)
				csr_do <= dmar_en;
			else if(csr_a[3:0] == 4'b0011)
				csr_do <= reply_data;
			else if(csr_a[3:0] == 4'b0010)
				csr_do <= request_data;
			else if(csr_a[3:0] == 4'b0001)
				csr_do <= request_addr;
			else if(csr_a[3:0] == 4'b0000)
				csr_do <= {request_write, request_en};
		end
	end
end
