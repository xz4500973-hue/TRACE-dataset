...
initial begin
  ...
  // 画一个矩形
  #2 wbs_cyc_i = 1; wbs_dat_i = 110 << 16; wbs_adr_i = GFX_DEST_PIXEL_X; #4 wbs_cyc_i = 0;
  #2 wbs_cyc_i = 1; wbs_dat_i = 110 << 16; wbs_adr_i = GFX_DEST_PIXEL_Y; #4 wbs_cyc_i = 0;
  #2 wbs_cyc_i = 1; wbs_dat_i = GFX_TEXTURE_ENABLE | GFX_COLORKEY_ENABLE | GFX_CTRL_CD16 | GFX_ACTIVE_POINT0 | GFX_FORWARD_POINT; wbs_adr_i = GFX_CONTROL; #4 wbs_cyc_i = 0;
  #2 wbs_cyc_i = 1; wbs_dat_i = 115 << 16; wbs_adr_i = GFX_DEST_PIXEL_X; #4 wbs_cyc_i = 0;
  #2 wbs_cyc_i = 1; wbs_dat_i = 115 << 16; wbs_adr_i = GFX_DEST_PIXEL_Y; #4 wbs_cyc_i = 0;
  #2 wbs_cyc_i = 1; wbs_dat_i = GFX_TEXTURE_ENABLE | GFX_COLORKEY_ENABLE | GFX_CTRL_CD16 | GFX_ACTIVE_POINT1 | GFX_FORWARD_POINT; wbs_adr_i = GFX_CONTROL; #4 wbs_cyc_i = 0;
  #2 wbs_cyc_i = 1; wbs_dat_i = GFX_DRAW_RECT | GFX_CTRL_CD16; wbs_adr_i = GFX_CONTROL; #4 wbs_cyc_i = 0;
