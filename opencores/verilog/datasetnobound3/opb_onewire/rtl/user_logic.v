...
(* keep_hierarchy = "yes" *) module user_logic
(
...
//----------------------------------------------------------------------------
  ...
  always @( slv_reg_read_select or slv_reg0 or slv_reg1 or slv_reg2 or slv_reg3 )
    begin: SLAVE_REG_READ_PROC
      ...
      if (slv_reg_read_select == 4'b1000)
        slv_ip2bus_data <= read_byte;
      else if (slv_reg_read_select == 4'b0100)
        slv_ip2bus_data <= slv_reg1;
      else if (slv_reg_read_select == 4'b0010)
        slv_ip2bus_data <= slv_reg2;
      else if (slv_reg_read_select == 4'b0001)
        slv_ip2bus_data <= onewire_status_register;
      else
        slv_ip2bus_data <= 0;
