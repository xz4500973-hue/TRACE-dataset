...
(* keep_hierarchy = "yes" *) module jt51_phasegen(
	input			 	clk,
	// Channel frequency
	input		[6:0]	kc,
	input		[5:0]	kf,
...
assign pow2_tern = (pow2ind_IV==3'd0)?5'd16:(pow2ind_IV==3'd1)?5'd17:(pow2ind_IV==3'd2)?5'd19:(pow2ind_IV==3'd3)?5'd20:(pow2ind_IV==3'd4)?5'd22:(pow2ind_IV==3'd5)?5'd24:(pow2ind_IV==3'd6)?5'd26:5'd29;
