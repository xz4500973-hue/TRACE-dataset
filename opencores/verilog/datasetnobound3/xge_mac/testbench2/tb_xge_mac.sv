...
initial begin
    ...
    #30000; reset_156m25_n = 1'b1; reset_xgmii_rx_n = 1'b1; reset_xgmii_tx_n = 1'b1;
end
...
initial begin
    for (tx_length = 0; tx_length <= 4000; tx_length = tx_length + 1) tx_buffer[tx_length] = 0;
    pkt_rx_ren = 1'b0; pkt_tx_data = 64'b0; pkt_tx_val = 1'b0;
    pkt_tx_sop = 1'b0; pkt_tx_eop = 1'b0; pkt_tx_mod = 3'b0;
end

// Mixed packet sizes with gaps
task SendMixedPacket;
  input [31:0] len;
  input [7:0] pattern;
  integer i;
  begin
...
initial begin
    #10000000;
    // Large variety of packet sizes
    SendMixedPacket(64,  8'hff);
    #1000000;
    SendMixedPacket(192, 8'hde);
    #2000000;
    SendMixedPacket(32,  8'had);
    #1000000;
    SendMixedPacket(384, 8'hbe);
    #2000000;
    SendMixedPacket(128, 8'hef);
    #10000000;
    $finish;
end
