...
module tb_ula;
    ...
    // Test procedure - variant 3: longer initial observation, different toggles
    initial begin
        // Generate VCD
        $dumpfile("ula.vcd");
        $dumpvars(0, tb_ula);
        ...
        // Initialize
        vramdout = 8'b01001001;
        ear = 0;
        kbcolumns = 5'b00111;

        // Extended initial run to capture full frame cycle
        #2_000_000;

        // Toggle kbcolumns rapidly
        kbcolumns = 5'b01011;
        #100_000;
        kbcolumns = 5'b11100;
        #100_000;
