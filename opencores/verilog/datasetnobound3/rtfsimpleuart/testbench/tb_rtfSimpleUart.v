...
module tb_rtfSimpleUart;
    ...
    initial begin
        ...
        uart_send_byte(8'hFF); while(!data_present) @(posedge clk);
        uart_send_byte(8'h00); while(!data_present) @(posedge clk);
        uart_send_byte(8'hAA); while(!data_present) @(posedge clk);
        uart_send_byte(8'h55); while(!data_present) @(posedge clk);
        uart_send_byte(8'h11); while(!data_present) @(posedge clk);
        #50000;
