...
module tb_tiny_spi;
    ...
    initial begin
        ...
        #100 rst_i=0;#100;
        wr(4,32'd2); wr(2,32'h3);
        // Aggressive: burst writes with minimal delay
        for(i=0;i<300;i=i+1)begin MISO<=$random%2;wr(1,$urandom%256);#400;end
        #5000;$display("Done at %0t",$time);$finish;
    end
endmodule