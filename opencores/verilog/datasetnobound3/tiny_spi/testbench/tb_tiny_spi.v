...
module tb_tiny_spi;
    reg rst_i,clk_i,stb_i,we_i,cyc_i; reg[2:0]adr_i; reg[31:0]dat_i;
    wire[31:0]dat_o; wire ack_o,int_o; wire MOSI,SCLK; reg MISO;
    ...
    initial begin
        ...
        #100 rst_i=0;#100;
        wr(4,32'd0);  // default baud rate
        wr(2,32'h1);  // enable tx irq only
        for(i=0;i<100;i=i+1)begin MISO<=1;wr(1,8'hAA);#1000; MISO<=0;wr(1,8'h55);#1000;end
        #5000;$display("Simulation finished at %0t",$time);$finish;
    end
endmodule