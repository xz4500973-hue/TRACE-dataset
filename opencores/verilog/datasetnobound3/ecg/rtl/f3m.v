...
// f3m_mult: C = A * B, in field GF(3^M) -- refactored: 1-segment explicit FSM
...
// c0 == a0*b0; c1 == a1*b1; c2 == a2*b2; all in GF(3^M) -- refactored: 1-segment explicit FSM
(* keep_hierarchy = "yes" *) module f3m_mult3(clk, reset, 
    ...
    localparam S_M0 = 2'd0;
    localparam S_M1 = 2'd1;
    localparam S_M2 = 2'd2;
    localparam S_DONE = 2'd3;
    
    reg [1:0] state;

    f3m_mux3
        ins9 (a0, (state == S_M0), a1, (state == S_M1), a2, (state == S_M2), in1),
        ins10 (b0, (state == S_M0), b1, (state == S_M1), b2, (state == S_M2), in2);
    f3m_mult
