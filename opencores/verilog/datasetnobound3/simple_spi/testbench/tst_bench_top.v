/////////////////////////////////////////////////////////////////////
////  simple_spi testbench (variant 3): cpol=1, cpha=1, e sweep 0..7, 20 bytes per
/////////////////////////////////////////////////////////////////////
`timescale 1ns / 1ps
...
module tst_bench_top();
	...
	initial begin
		...
		for (e=0; e<=7; e=e+1) begin
			force spi_slave.cpol=1; force spi_slave.cpha=1;
			u0.wb_write(1, SPCR, {4'b0101, 1'b1, 1'b1, e[1:0]});
			u0.wb_write(1, SPER, {6'h0, e[1:0]});
			for(n=0; n<20; n=n+1) begin
				u0.wb_write(1, SPDR, {4'hA, n[3:0]});
				u0.wb_read(1, SPSR, q);
		...
		#50000;
		$display("TB v3 doone at %0t", $time);
		$finish;
	end
endmodule