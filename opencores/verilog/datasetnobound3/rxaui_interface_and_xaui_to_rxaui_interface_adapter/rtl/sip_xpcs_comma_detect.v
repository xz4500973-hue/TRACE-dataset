...
// 12/12/2007  : created
//-----------------------------------------------------------------------------
(* keep_hierarchy = "yes" *) module sip_xpcs_comma_detect (/*AUTOARG*/
   // Outputs
   lock, rout, 
   // Inputs
...
(* keep_hierarchy = "yes" *) module sip_xpcs_cd_sync (/*AUTOARG*/
   // Outputs
...
(* keep_hierarchy = "yes" *) module sip_xpcs_cd_7bit (/*AUTOARG*/
   // Outputs
   position_7bit, 
   // Inputs
...
(* keep_hierarchy = "yes" *) module sip_xpcs_cd_10bit (/*AUTOARG*/
   // Outputs
   position_10bit, 
   // Inputs
...
(* keep_hierarchy = "yes" *) module sip_xpcs_cd_ssm (/*AUTOARG*/
   // Outputs
...
(* keep_hierarchy = "yes" *) module sip_xpcs_cd_mux (/*AUTOARG*/
   // Outputs
   rout, 
   // Inputs
