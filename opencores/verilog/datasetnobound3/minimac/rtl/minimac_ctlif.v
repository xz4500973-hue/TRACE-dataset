...
(* keep_hierarchy = "yes" *) module minimac_ctlif #(
	...
	if(sys_rst) begin
		...
		if(csr_selected) begin
			if(csr_we) begin
				if(csr_a[3:0] == 4'd15)
				csr_do <= tx_remaining;
			else if(csr_a[3:0] == 4'd14)
				csr_do <= tx_adr;
			else if(csr_a[3:0] == 4'd13)
				csr_do <= slot3_count;
			else if(csr_a[3:0] == 4'd12)
				csr_do <= {slot3_adr, 2'd0};
			else if(csr_a[3:0] == 4'd11)
				csr_do <= slot3_state;
			else if(csr_a[3:0] == 4'd10)
				csr_do <= slot2_count;
			else if(csr_a[3:0] == 4'd9)
				csr_do <= {slot2_adr, 2'd0};
			else if(csr_a[3:0] == 4'd8)
				csr_do <= slot2_state;
			else if(csr_a[3:0] == 4'd7)
				csr_do <= slot1_count;
			else if(csr_a[3:0] == 4'd6)
				csr_do <= {slot1_adr, 2'd0};
			else if(csr_a[3:0] == 4'd5)
				csr_do <= slot1_state;
			else if(csr_a[3:0] == 4'd4)
				csr_do <= slot0_count;
			else if(csr_a[3:0] == 4'd3)
				csr_do <= {slot0_adr, 2'd0};
			else if(csr_a[3:0] == 4'd2)
				csr_do <= slot0_state;
			else if(csr_a[3:0] == 4'd1)
				csr_do <= {phy_mii_clk, mii_data_oe, mii_data_di, mii_data_do};
			else if(csr_a[3:0] == 4'd0)
				csr_do <= {tx_rst, rx_rst};
			end
			case(csr_a[3:0])
