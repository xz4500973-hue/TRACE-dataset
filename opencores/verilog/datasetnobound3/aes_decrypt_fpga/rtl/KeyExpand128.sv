...
//// VARIANT: One-hot state encoding (11 states)                  ////
////                                                              ////
//////////////////////////////////////////////////////////////////////
...
(* keep_hierarchy = "yes" *) module KeyExpand128(
	...
	logic	[10:0]	keyexp_state;	// One-hot: 11 states
	logic	[0:7]	Rcon;
	...
	// Key Expansion state machine - one-hot encoded	
	always_ff @(posedge clk)
	begin
		if (rst)
		begin
			keyexp_state <= 11'b00000000001;
			Rcon <= 8'h01;
		end
		else begin
