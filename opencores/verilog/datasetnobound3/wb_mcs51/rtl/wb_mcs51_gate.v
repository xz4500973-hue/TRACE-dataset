...
module wb_mcs51 ( nrst_i, clk_i, mcs51_ale, mcs51_rd, mcs51_wr, mcs51_ad_inout, 
  ...
  DFNCND1BWP12T30P140 addr_r_reg_7_ ( .D(mcs51_ad_inout[7]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[7]) );
  DFNCND1BWP12T30P140 addr_r_reg_6_ ( .D(mcs51_ad_inout[6]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[6]) );
  DFNCND1BWP12T30P140 addr_r_reg_5_ ( .D(mcs51_ad_inout[5]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[5]) );
  DFNCND1BWP12T30P140 addr_r_reg_4_ ( .D(mcs51_ad_inout[4]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[4]) );
  DFNCND1BWP12T30P140 addr_r_reg_3_ ( .D(mcs51_ad_inout[3]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[3]) );
  DFNCND1BWP12T30P140 addr_r_reg_2_ ( .D(mcs51_ad_inout[2]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[2]) );
  DFNCND1BWP12T30P140 addr_r_reg_1_ ( .D(mcs51_ad_inout[1]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[1]) );
  DFNCND1BWP12T30P140 addr_r_reg_0_ ( .D(mcs51_ad_inout[0]), .CPN(mcs51_ale), 
        .CDN(nrst_i), .Q(wbm_adr_o[0]) );
